        ...
        <div class="form-group">
      	...
      	<div class="form-group">
        	...
        	<div class="col-md-1 col-sm-1 col-xs-12">
          		<input type="number" id="txtPosition" name="txtPosition" value="5" required="required" class="form-control col-md-7 col-xs-12">
        	</div>
      	</div>
      	<div class="form-group">
        	<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" style="width: 70px">
          		<input type="submit" id="btnAddCatalog" name="btnAddCatalog" required="required" class="btn btn-success" value="Thêm">
        	</div>
      	</div>
	</form>
</div>