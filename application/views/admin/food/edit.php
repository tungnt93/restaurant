    ...
    <form id="formAddCatalog" data-parsley-validate class="form-horizontal form-label-left" method="post"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <input type="text" id="txtName" name="txtName" value="<?php echo $food->name ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
                <select class="form-control" name="slCatalog">
                    <?php foreach ($catalogs as $row){ ?>
                        <option value="<?php echo $row->id ?>" <?php echo $row->id == $food->catalog_id ? 'selected' : '' ?>><?php echo $row->name?></option>
                    <?php }?>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
                <input type="text" id="txtDram" name="txtDram" value="<?php echo $food->dram ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-2" style="width: 70px">
                <input type="submit" id="btnEdit" name="btnEdit" required="required" class="btn btn-success" value="Cập nhật">
            </div>
        </div>
    </form>
